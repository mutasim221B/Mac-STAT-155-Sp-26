...
We can modify this code to *also* include information about `weekend`.
...
Recall: Estimated model formula is given by:
...
We can modify the code below to recreate this plot.
