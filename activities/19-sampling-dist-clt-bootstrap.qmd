...
# Exercises: 
- Make sure that you are sunchronozed in your group.
- Work through the following exercises in your group - if you finish all of them, then collect your quiz paper and I will see you on Friday!
...
a. `map_df()` repeats the code within the parentheses as many times as you tell it. map_df()` does repetition like a for loop.
...
No matter the sample size, the sample estimates are normally distributed around the same value (here the sample slope since we're sampling from the sample).
But as sample size increases, the variability of the sample estimates decreases.
