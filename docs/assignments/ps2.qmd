...
```{r}
# Construct a visualization of the NER values from 2018
# This plot should have just 1 variable (NER)!


# Calculate the minimum, median, and maximum NER value in 2018
# Do all 3 calculations in 1 set of lines
